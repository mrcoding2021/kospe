...
<body>
    <div style="text-align: center;">
        <h3>FORM PENGAJUAN PERMOHONAN PEMBIAYAAN HNI</h3>
                ...
                <tr>
                    <td>
                        <div style="width: 350px; max-width: 350px">
                            <table>
                                <tr>
                                    <td class="q">Id. Anggota KoSPE</td>
                                    <td class="n">:</td>
    ...
    <div style="font-size:12px;">
        <div style="background-color: #616161;">
            <h5 style="text-align: center;color: white;">Data Keagenan HNI</h5>
        </div>
        <div>
                ...
                <tr>
                    ...
                    <td>
                        <div style="width: 350px; max-width:350px">
                            <table>
                                <tr>
                                    <td class="q">BC Perekomendasi</td>
                                    <td class="n">:</td>
                                    <td class="a"><?= $key->hni ?></td>
                                </tr>
                                <tr>
                                    <td class="q">ID. BC Perekomendasi</td>
                                    <td class="n">:</td>
                                    <td class="a"><?= $key->id_led ?></td>
                                </tr>
                                <tr>
                                    <td class="q">Nama PJ BC </td>
                                    <td class="n">:</td>
