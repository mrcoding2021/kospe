        ...
        <div class="card-body">
          <ul class="nav nav-pills mb-3 border-bottom-primary" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
              <a class="nav-link " id="pills-home-tab" data-toggle="pill" href="#rekening" role="tab" aria-controls="pills-home" aria-selected="true">Data Rekening</a>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <li class="nav-item" role="presentation">
              <a class="nav-link active" id="pills-contact-tab" data-toggle="pill" href="#angsuran" role="tab" aria-controls="pills-contact" aria-selected="false">Data Angsuran</a>
            </li>
            <li class="nav-item" role="presentation">
          ...
          <div class="tab-content " id="pills-tabContent">
            <div class="tab-pane fade " id="rekening" role="tabpanel" aria-labelledby="pills-home-tab">
            ...
            <div class="tab-pane fade show active" id="angsuran" role="tabpanel" aria-labelledby="pills-contact-tab">
