              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center mb-5">
                    <img src="<?= base_url('asset/img/agen-kospe.png') ?>" alt="" width="50%">

                  </div>
                  <form class="agenLogin" action="<?= base_url('agen/auth') ?>" method="post">
                  ...
                  <!-- <div class="text-center">
                    <a class="small" href="<?= base_url('agen/forgot_password') ?>">Forgot Password?</a>
                  </div> -->
                  <div class="text-center">
                    <a class="small" href="<?= base_url() ?>">Back to KoSPE.net</a>
                  </div>
                </div>
              </div>
            </div>
