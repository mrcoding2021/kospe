                            ...
                            <div class="row">
                              <div class="col-md-5">
                                <div class="form-group row">
                                  ...
                                  <label for="1" class="col-sm-8 col-form-label border-bottom-dark"><?= $sekolah->nama ?></label>
                                </div>
                                <div class="form-group row">
                                  <label for="1" class="col-sm-4 col-form-label">Alamat Sekolah</label>
                                  <label for="1" class="col-sm-8 col-form-label border-bottom-dark"><?= $sekolah->alamat ?></label>
                                </div>
                                <div class="form-group row">
                                  <label for="1" class="col-sm-4 col-form-label">No. HP Sekolah</label>
                                  <label for="1" class="col-sm-8 col-form-label border-bottom-dark"><?= $sekolah->hp ?></label>
                                </div>
                              ...
                              <div class="col-md-5">
                                ...
                                <div class="form-group row">
                                  ...
                                  <label for="1" class="col-sm-8 col-form-label border-bottom-dark"><?= $sekolah->email ?></label>
                                </div>
                                <div class="form-group row">
                                  <label for="1" class="col-sm-4 col-form-label">Penanggungjawab</label>
                                  <label for="1" class="col-sm-8 col-form-label border-bottom-dark"><?= $sekolah->pj ?></label>
                                </div>
                              </div>
                            </div>
                            ...
                            <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                              ...
                              <tbody>
                                ...
                                foreach ($pelajar as $key) : ?>
                                  ...
                                  <tr>
                                    <td><?= $no++ ?></td>
                                    <td><?= shortdate_indo($key->date_created) ?>
                                    </td>
                                    <td>
                                      <?= $key->id_user ?>
                                    </td>
                                    ...
                                    <td>
                                      <?php $this->db->select_sum('kredit', 'saldo');
                                      $this->db->where('id_murid', $key->id_user);
                                      $saldo_sekolah = $this->db->get('tb_tansaksi')->row();
                                      $saldoS = 0;
                                      echo rupiah($saldo_sekolah->saldo)
                                      ?>
                                    </td>

                                    <td width="12%">
                                      <a href="#detail" data-toggle="modal" class="badge badge-primary detail">Lihat</a>
                                      <a href="#mutasi<?= $key->id_user ?>" data-toggle="modal" class="badge badge-success">Mutasi</a>
                                      <a href="<?= base_url('sipajar/is_active' . $key->id_user) ?>" class="badge badge-danger">Aktif</a>
                                    </td>
                                  <?php endforeach ?>
                                  </tr>
                        ...
                        <form action="<?= base_url('sipajar/addPelajar') ?>" method="post">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              ...
                              <input type="hidden" class="form-control" value="<?= $sekolah->id_user ?>" name="id_sekolah">
                            </div>
                          </div>
                          <div class="form-group row">
                ...
                $no = 1;
                foreach ($pelajar as $key) : ?>
                  <div class="modal fade" id="mutasi<?= $key->id_user ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header bg-info text-white">
                          ...
                          <div class="table-responsive">
                            <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                              ...
                              <tbody>
                                ...
                                $saldo = 0;
                                $this->db->where('id_murid', $key->id_user);
                                $transaksii = $this->db->get('tb_tansaksi')->result();

                                foreach ($transaksii as $key) : ?>
                                  <?php if ($key->kredit == 0) {
