         ...
         <div class="row">
             ...
             <div class="span4">
                 <ul class="breadcrumb">
                     ...
                     <li><a href="<?= base_url('home/pembiayaan') ?>"><?= $parent ?></a><i class="icon-angle-right"></i></li>
                     ...
                     <div class="row">
                         <div class="span8">
                             <div class="post-image">
                                 <img src="<?= base_url('asset/img/post/')  ?>akad-syariah.jpg" alt="" width="100%" />
                             </div>
                             ...
                             <p>
                                 ...
                                 <strong>QORD</strong><br> Pembiayaan kepada nasabah untuk dana talangan segera dalam jangka waktu yang relatif pendek, dan dana tersebut akan dikembalikan secepatnya sejumlah uang yang digunakannya. Dalam transaksi ini, nasabah hanya mengembalikan pokok.
                             </p>
